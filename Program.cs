        ...
        static void Main(string[] args)
        {
            ...
            switch (args[0])
            {
                ...
                case "--add-account":
                    ...
                    {
                        cfg.SetupVPN(args[1], args[2], args[3]);
                    }
                    break;
                ...
                case "--list-account":
                    ...
                    Console.WriteLine("------------------------------------------------------------------");
                    foreach (Config.VPN vpn in cfg.GetAllVPN())
                    {
                ...
                case "-s":
                case "--start":
                    if (cfg.EntryName == "" || cfg.GetAllVPN().Length == 0)
                    {
                    ...
                    else
                    {
                        ...
                        while (true)
                        {
                            ...
                            if (bDisconnected)
                            {
                                foreach (Config.VPN rec in cfg.GetAllVPN())
                                {
